...
# Usage（官方）: irm https://openclaw.ai/install.ps1 | iex
# 本仓库: irm https://raw.githubusercontent.com/Zhangyao719/openclaw-installer/main/install.ps1 | iex
# 带参: & ([scriptblock]::Create((irm 'https://raw.githubusercontent.com/Zhangyao719/openclaw-installer/main/install.ps1'))) -NoOnboard
